...
class Palpation():
    ...
    def execute_raster_single_row_both_directions(self, n, pick_up_tool=True):
        """ Repeatedly passes n times over a single row of a tissue brick in both directions"""
